...
class Dashboard extends Component {
  ...
  fetchMessageList(deviceParam, severityParam){
    ...
    if(sParam == undefined)
       sParam = '';
    fetch("http://localhost:8080/messages?deviceName="+dParam+"&severity="+sParam)
      .then(res => res.json())
      .then(
        (result) => {
          this.setState({
  ...
  fetchDeviceStatistics(deviceParam){
    ...
    if(deviceName==undefined)
       deviceName=''
    fetch("http://localhost:8080/device/stats?deviceName="+deviceName)
      .then(res => res.json())
      .then(
        (result) => {
  ...
  fetchMessageStatistics(deviceParam, sevParam){
    ...
    fetch("http://localhost:8080/message/stats?deviceName="+dParam+"&severity="+sParam)
      .then(res => res.json())
      .then(
        (result) => {
          var l = [];
